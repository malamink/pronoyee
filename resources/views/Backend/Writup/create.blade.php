        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Insert writup information</h6>
                </div>                
                <div class="card-body">
                    <form action="{{ route('writups.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="WriterName" name="WriterName" value="{{old('WriterName')}}" placeholder="Enter WriterName">
                                    @error ('WriterName')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                    *Note : [image size- height: 150px; wedth: 250px; reg: 72; max: 25kb;]
                                </div>
                            </div>
                            <div class="form-group row">
