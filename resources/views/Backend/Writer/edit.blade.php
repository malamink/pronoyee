        ...
        <div class="col-md-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Update Writer information</h6>
                </div>
                    ...
                    <form action="{{ route('writers.update',$writer->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @method('put')
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="wNameBn" name="wNameBn" value="{{ $writer->wNameBn}}">
                                    @error ('wNameBn')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="wNameEn" name="wNameEn" value="{{ $writer->wNameEn}}">
                                    @error ('wNameEn')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select  id="country-dropdown" class="form-control" name="CountryName" value="{{ $writer->CountryName}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="state-dropdown" name="StateName" value="{{ $writer->StateName}}" >                                    
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="wBplace" class="col-sm-3 col-form-label">জন্মস্থান </label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="wBplace" name="wBplace" value="{{ $writer->wBplace}}">
                                    @error ('wBplace')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="wLanguage" class="col-sm-3 col-form-label";>মাতৃভাষা</label>
                                <div class="col-sm-9">
                                <select id="Language" class="form-control" name="Language" value="{{ $writer->Language}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select id="wTperiod" class="form-control" name="wTperiod" value="{{ $writer->wTperiod}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="wDbirth" name="wDbirth" value="{{ $writer->wDbirth}}">
                                    @error ('wDbirth')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control" id="image" name="image" value="{{ $writer->image}}">
                                    @error ('image')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="wBiography" id="wBiography" rows="4">{{ $writer->wBiography}}"</textarea>
                                    @error ('wBiography')
                                    <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
