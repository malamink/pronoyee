                ...
                <div class="card-body">                
                    <form action="{{route('bookshelves.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                                <label for="BslN" class="col-sm-3 col-form-label"> বইয়ের ক্রমিক নম্বর </label>
                                <div class="col-sm-9">
                                <input type="number" class="form-control" name="BslN" id="BslN" placeholder="Type book serial number">
                                @error ('BslN')
