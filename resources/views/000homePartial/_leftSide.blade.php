		...
		<aside class="widget-navigation  myScroll">
			...
			<div class="toggles">
				...
				<div class="content widget-categories">
					...
					@foreach($writerview as $timeperiodList)
						<li><a href="{{ $timeperiodList->id}} "> {{ $timeperiodList->wNameBn}}  </a></li>	
					@endforeach
				...
				<div class="content widget-categories">
					<ul>
						<li><a href="{{url('publications')}}">প্রণয়ী পাবলিকেশন</a></li>
				...
				<div class="content-title"><span>জেলাভিত্তিক লেখকবৃন্দ</span></div>
					...
					<div class="content widget-categories">
						<ul>
							<li><a href="{{url('districtwriter')}}">বগুড়া</a></li>
							<li><a href="bogura_view.php">বগুড়া</a></li>
						</ul>
					</div>
					<!--/toggles content -->
					<!-- content-title -->
					...
					<div class="content widget-categories">
						<ul>
							<li><a href="{{url('programme')}}">গ্রাম ভিত্তিক বইপড়া</a></li>
							<li><a href="#">বৃক্ষ রোপন </a></li>
						</ul>
					</div>
					<!--/toggles content -->
					<!-- content-title -->
