				...
				<div class="content widget-categories">
					<ul>
						@foreach($bookcat as $bookcatList)
							<li><a href="{{ $bookcatList->id}} "> {{ $bookcatList->BookCatName}}  </a></li>	
						@endforeach
				...
				<div class="content widget-categories">
					<ul>
						@foreach($publication as $publicationList)
							<li><a href="{{ $publicationList->id}} "> {{ $publicationList->PublicationName}}  </a></li>	
						@endforeach
					</ul>
				</div>
				<!--/toggles content -->
				...
				<div class="content-title"><span>জেলাভিত্তিক লেখকবৃন্দ</span></div>
					...
					<div class="content widget-categories">
						...
						@foreach($writer as $writerList)
							<li><a href="{{ $writerList->id}} "> {{ $writerList->StateName}}  </a></li>	
						@endforeach
						</ul>
					</div>
					<!--/toggles content -->
					...
					<div class="content widget-categories">
						<ul>
							@foreach($programme as $programmeList)
								<li><a href="{{ $programmeList->id}} "> {{ $programmeList->ProgrammeName}}  </a></li>	
							@endforeach
						</ul>
					</div>
					<!--/toggles content -->
